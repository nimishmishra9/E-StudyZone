...
<style>
                        ...
                        <li class="hvr hvr-bounce-in"><i><b><a href=""> Manage Users </a></b></i></li>
                         <li class="hvr hvr-bounce-in"><i><b><a href="">Manage Response</a></b></i></li>
                          <li class="hvr hvr-bounce-in"><i><b><a href="">Upload Center</a></b></i></li>
                           <li class="hvr hvr-bounce-in"><i><b><a href="managenewsevent.sp">  Manage News & Events </a></b></i></li>
 ...
 <div class="row">  
     <div class="col-sm-9" style=" min-height:390px;margin-left:-8px;background:#00bfa5;overflow-x: scroll;overflow-y: scroll;"> 
         ...
         <center>     <table border="1px solid black;">
             ...
             %>
             <tr>
                 <td><%=sr.getString("STID")%></td>
                 <td><%=sr.getString("name")%></td>
                 <td><%=sr.getString("email")%></td>
                 <td><%=sr.getString("passwd")%></td>
                 <td><%=sr.getString("phoneno")%></td>
                 <td><%=sr.getString("city")%></td>
                 <td><%=sr.getString("address")%></td>
                 <td><%=sr.getString("gender")%></td>
                 <td><%=sr.getString("fname")%></td>
                 <td><%=sr.getString("aadharno")%></td>
                 <td><%=sr.getString("udate")%></td>
                
                 <td><a href="admincode/deleteregistration.jsp?id=<%=sr.getString("email")%>">delete</a></td>
             </tr>
             <%
                    }
             %>
