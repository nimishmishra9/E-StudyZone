...
<style>
    ...
    <body>
        ...
        <div class="col-sm-12">
           ...
           <div class="row">     <div class="middle" style=" margin-bottom:-8px;"> 
                      <div class="col-sm-12">
                          <div class="col-sm-3" style="min-height:600px;background:#3c3c3c;">
 ...
 <div class="row">   <div class="col-sm-9" style=" min-height:600px;margin-left:-8px; background:#00bfa5;"> 
                 
         <div class="col-sm-4"></div>
         <form action="admincode/insertnews.jsp">
         <div class="col-sm-4"><br/><br/><br/><br/><form style="background:rgba(0,0,0,.3);border-radius:10px 10px 10px 10px">
       <br>   <br> <div class="input-group">
  <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-pencil"></span></span>
  <textarea  name="msg" class="form-control" placeholder="write new news & events" aria-describedby="basic-addon1"></textarea>
</div><br/>
