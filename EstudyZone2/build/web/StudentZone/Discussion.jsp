                    ...
                    <form action="stcode/postquestion.jsp" method="post">    
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="question" class="form-control" required="true" placeholder="enter the Question" aria-describedby="basic-addon1"/>
                            ...
                            <div class="col-sm-12" >
                                ...
                                <table class="table table-bordered table-hover table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="reply.jsp?qid=<%=rs.getString("qid")%>&qus=<%=rs.getString("qtext")%>">Reply</a></td>   
                                        <td><a href="showans.jsp?qid=<%=rs.getString("qid")%>&qtext=<%=rs.getString("qtext") %>">View</a></td>   
