...
<style>
 ...
 <div class="row">   <div class="col-sm-9" style=" min-height:390px;margin-left:-8px; background:#00bfa5; "> 
           ...
           <h2 style="color:white; margin-left:270px;">Change your password!!</h2><br>
           <div class="col-sm-3"></div>  <form action="stcode/changepassword.jsp" methode="post">   <div class="col-sm-4" style="background:rgba(0,0,0,.3); border-radius:10px 10px 10px 10px;height:250px;"> 
