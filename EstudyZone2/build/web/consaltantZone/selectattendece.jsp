...
<style>
        ...
        <div class="col-sm-12">
            <div class="outer">
              ...
              Dbmanager db=new Dbmanager();
                               String str="select NAME from consreg where EMAIL='"+session.getAttribute("username")+"'";
                              ResultSet rs=db.getRecord(str);
                              rs.next();
                            %>
                            <p style="font-family: sans-serif,cursive;font-size: 20px;">HII!!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=rs.getString("NAME")%></p>
 ...
 <div class="row">   <div class="col-sm-9" style=" min-height:400px;margin-left:-8px; "> 
       ...
       <%
                                            String q = "select name from consreg where EMAIL='" + session.getAttribute("username") + "'";
                                        db = new Dbmanager();
                                             rs = db.getRecord(q);
                                           if(rs.next())
                                            {
...
<div class="input-group">
  ...
  <input type="submit" value="submit now!!!" class="form-control"  aria-describedby="basic-addon1" style="background:lightseagreen; color:white"/>
  <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-send"></span></span>
</div><br/>                        
