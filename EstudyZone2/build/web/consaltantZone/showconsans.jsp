         ...
         <div class="row" >
                            <div class="col-sm-12" >
                                ...
                                <table class="table table-bordered table-hover table-responsive">
                                    ...
                                    <tr>
                                        <th colspan="2" align="center"><%=request.getParameter("qtext") %></th>
                                    </tr>
                                    <%
                                        int n = 1;
                                        Dbmanager d = new Dbmanager();
                                        String q="select * from ans  where qid='"+request.getParameter("qid")+"' order by aid desc";
