...
<style>
 ...
 <div class="row">   <div class="col-sm-9" style=" min-height:390px;margin-left:-8px;background:#00bfa5;"> 
         ...
         <div class="col-sm-4"></div>  <div class="col-lg-4" style=" background:rgba(0,0,0,.3);border-radius:10px 10px 10px 10px;margin-top:60px ">  <form action="code/feedbackcode.jsp">   
                                  <br><div class="input-group">
  <span class="input-group-addon" id="basic-addon1"><span class="fa fa-comment-o"></span></span>
  <textarea name="feedback" class="form-control" placeholder="give your feedback" aria-describedby="basic-addon1"></textarea>
</div><br/>
