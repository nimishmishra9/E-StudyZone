...
<style>
 ...
 <div class="row">   <div class="col-sm-9" style=" min-height:400px;margin-left:-8px; background:#00bfa5;"> 
         <center><br><br><br><br><form action="" methode="post" style=" margin-left:300px">   <div class="col-sm-4" style="background:rgba(0,0,0,.3); border-radius:10px 10px 10px 10px;height:250px;"> 
                                  <br><br> <div class="input-group">
  <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-user"></span></span>
  <input type="password" name="oldpass" class="form-control" placeholder="enter the old password" aria-describedby="basic-addon1"/>
                                  </div> <br/>
                                  
                                   <div class="input-group">
  <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-pencil"></span></span>
  <input type="password" name="newpassword" class="form-control" placeholder="enter the new password" aria-describedby="basic-addon1"/>
                                  </div> <br/>
                                  <div class="input-group">
  <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-sort-by-alphabet"></span></span>
  <input type="password"  name="confirmpass" class="form-control" placeholder="confirm the new password" aria-describedby="basic-addon1"/>
                                 </div> <br/>
                                  <div class="input-group">
  <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-send"></span></span>
  <input type="submit" value="Save your New Password" class="form-control" style="color:white; background:lightseagreen;"/>
  <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-send"></span></span>
                                  </div> <br/>
<br/><br>
                 </div></form></center>                   
