                    ...
                    <div class="row">    <div class="row"> <div class="middle" style=" margin-bottom:-8px;"> 
                                <div class="col-sm-12">
                                    ...
                                    <div class="row">   <div class="col-sm-9" style=" min-height:390px;margin-left:-8px;background:#00bfa5;  "> 
                                            <div class="col-sm-4"></div> <form action="../uploadmaterial" method="post" enctype="multipart/form-data">   <div class="col-lg-3" style="margin-top:100px; background:rgba(0,0,0,.3);border-radius:10px 10px 10px 10px">  
                                                <br>
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-file"></span></span>
                                                    <input type="file" name="upfile" value="Select a File" class="form-control"  aria-describedby="basic-addon1"/>
                                                </div><br/>
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-comment"></span></span>
                                                    <input type="text" name="msg"  placeholder="give the messege" class="form-control"  aria-describedby="basic-addon1"/>
                                                </div><br/>
                                                <div class="input-group">
